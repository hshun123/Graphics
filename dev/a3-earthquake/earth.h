...
public:
    ...
    // Eric 
    // update mesh to reflect globalbtn pressed
    void Updae_global();

    // return the value of current globalbtn value
    bool Globe() { return globe_btn; };

    
protected:

    // a boolean to chekck globalbtn value
    bool globe_btn = false;
